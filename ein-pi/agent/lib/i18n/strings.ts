...
const EN: Record<string, string> = {
	...
	"cmd.sdd-check.description": "Validate a change (all phases) or lint a design.md path",
	...
	"help.short": [
		...
		"- /ein:sdd-check [change | path] → validate a change (all phases) or lint a design.md path",
...
const ES: Record<string, string> = {
	...
	"cmd.sdd-check.description": "Validar un cambio (todas las fases) o lintar un path de design.md",
	...
	"help.short": [
		...
		"- /ein:sdd-check [cambio | ruta] → valida un cambio (todas las fases) o lint de un design.md",
	...
	"help.full": [
		...
		"- /ein:sdd-check [cambio | ruta] → validar un cambio (todas las fases) o lint de un design.md.",

...
const ENTRIES = [".pi/ein/", ".piagents/", ".pi-subagents/", ".codegraph/", "openspec/changes/**/continuity.json", ".ein/continuity.json", ".ein/continuity-operations.json", ".ein/continuity-operations.json.lock", ".ein/continuity-operations.json.lock.release-*", ".ein/continuity-operations.json.tmp-*"];

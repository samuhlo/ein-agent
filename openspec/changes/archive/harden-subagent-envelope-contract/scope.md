...
Spec delta: PRESENT (revokes the `spec_delta: none` deferral above). Registered
via `cc-ein-sdd delta harden-subagent-envelope-contract --domain surface-wiring`
— 5 ADDED scenarios in `openspec/specs/surface-wiring/spec.md` (R1-R5 of
`design.md`), synchronized (`cc-ein-sdd sync`).

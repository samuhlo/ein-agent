...
requirement: The system MUST deploy the canonical `runtime/assets/orchestrator.md` into the isolated Claude home at the path promised by the Claude adapter, preserving its bytes.

...
**Estado:** implemented-pending-verification

La matriz y la política de Bun están implementadas; la evidencia de CI sigue pendiente de `sdd-verify`.
...
- [ ] La matriz DEBE incluir `ubuntu-latest` y `macos-latest` para los tres trabajos compatibles.
- [ ] Docker E2E DEBE ejecutarse solo en Ubuntu.
- [ ] La política de Bun DEBE ser controlada y documentada.
- [ ] La documentación NO DEBE afirmar soporte nativo de Windows.
...
- [ ] Matriz declarada.
- [ ] Política Bun documentada.
- [ ] Evidencia de CI archivada.

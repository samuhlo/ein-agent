---
name: issue-creation
description: "Create Ein issues with issue-first checks. Trigger: creating GitHub issues, bug reports, or feature requests."
license: Apache-2.0
metadata:
  author: samuhlo
  version: "1.0"
...
4. **Questions go to repository discussions**, not issues

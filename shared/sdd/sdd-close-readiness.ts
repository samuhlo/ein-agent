// =============================================================================
// SDD CLOSE READINESS — SHARED POLICY
// Decide si un cambio puede cerrarse leyendo el filesystem y un estado SDD
// inyectado; no conoce runtimes, Git, procesos ni configuración.
// =============================================================================
...
export type AssessCloseReadiness = (
	cwd: string,
	change: string,
	options?: CloseReadinessOptions,
) => CloseReadiness;
export type CloseReadinessDependencies = Readonly<{
...
export function createAssessCloseReadiness(
	dependencies: CloseReadinessDependencies,
): AssessCloseReadiness {
	return (cwd, change, options = {}) => {

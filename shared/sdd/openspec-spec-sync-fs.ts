...
import { parseSyncReport, planOpenSpecSync, serializeSyncReport, type OpenSpecSyncPlan, type SyncBaseInput, type SyncDeltaInput } from "./openspec-spec-sync.ts";
import { digestManifest, serializeOpenSpec } from "./openspec-spec-contract.ts";

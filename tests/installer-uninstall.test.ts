...
function seed(): { home: string; binDir: string } {
  ...
  for (const path of [".pi-ein/agent/app.ts", ".pi-ein/agent/ein-mode.json", ".pi-ein/agent/agents/ein-git.md", ".config/fish/functions/ein-pi.fish", ".local/bin/ein", ".local/bin/ein-install", ".claude-ein/CLAUDE.md", ".claude-ein/settings.json", ".claude-ein/agents/ein-git.md", ".claude-ein/commands/ein/handoff.md", ".config/fish/functions/ein-cc.fish"]) put(path);

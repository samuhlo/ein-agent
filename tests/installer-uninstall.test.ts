...
describe("recoverable uninstall", () => {
  test("moves selected assets to one private recovery directory", () => {
    ...
    expect(readFileSync(join(fixture.home, ".engram-ein/store"), "utf8")).toBe("MEMORY");
    expect(readFileSync(join(fixture.home, ".engram/store"), "utf8")).toBe("FOREIGN-MEMORY");
    expect(readFileSync(join(fixture.home, ".local/bin/engram"), "utf8")).toBe("GLOBAL-BINARY");

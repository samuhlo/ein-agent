...
describe("orchestrator: flujo por fases determinista", () => {
	...
	test("documenta sdd-next como traspaso manual sin sustituir el router interno", () => {
		...
		expect(orch).toContain("continue with the checked navigation after each phase");
	});
...
describe("adapter Pi: entrada transparente y decisión semántica del parent", () => {
	...
	test("el parent decide por significado y resuelve intent antes de un nuevo cambio", () => {

...
| `/ein:continuity continue` | Solo si aparece un límite de continuidad que Ein no pudo liberar: autoriza una operación registrada adicional. Normalmente basta pedir «continúa»; Ein revisa por sí mismo los apply parciales comprobables. No marca tareas SDD como terminadas ni elimina operaciones inciertas. |

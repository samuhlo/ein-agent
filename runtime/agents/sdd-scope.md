...
Read the confirmed `intent.md` for a new change and preserve its decisions. An already scoped legacy change may have none; pending or invalid intent blocks. Ein attaches the agreement key to full artifact writes; never copy hashes yourself. New product questions block for the parent.

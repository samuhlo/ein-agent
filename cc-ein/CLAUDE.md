...
- Provider store: `join(validatedAbsoluteHome, ".engram-cc-ein")`. Pi and Claude stores stay separate and are never merged or copied; EIN launch and handoff boundaries route the destination store.
